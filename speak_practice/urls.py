...
urlpatterns = [
    ...
    path('api/realtime-session/', views.realtime_session_api, name='realtime_session_api'),
    path('api/realtime-message/', views.realtime_message_api, name='realtime_message_api'),
    path('api/reply-suggestion/', views.reply_suggestion_api, name='reply_suggestion_api'),
